...
return results[1] || 0;
		...
		var aux = '<div class="col-sm-4"><img class="hlsd-index-img" src="'+projectTypeList.typeImage+'" width ="275px"><h3 id="hlsd-index-h3"><a href="logo-list-page.html?id='+projectNumber+'">'+typeName'</a></h3></div>';
