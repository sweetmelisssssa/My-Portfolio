...
return results[1] || 0;
		...
		function drawProject(projectType)
		{
		
		var aux = '<div class="col-sm-4"><img class="hlsd-logo-list-page-img" src="'+projectType.thumb+'" width ="275px"><h3 id="logo-list-page-logo-name">'+projectType.name+'</h3><p id="logo-list-page-description">'+projectType.description+'</p></div>';
